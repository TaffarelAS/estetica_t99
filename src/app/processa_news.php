<?php
    ...
    # recebemos o dado no formulario HTML e armazenamos na variavel $email
    $email = $_POST['email'];
    ...
    $sql_insere_email = "INSERT INTO estetica_t99.news ( email )
    VALUES ( ? )";

    # 3. Executar o comando atraves da conexão
